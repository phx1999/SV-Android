...
import com.sv.speakerverify.BuildConfig;
import com.sv.speakerverify.MySharedPreferences;
import com.sv.speakerverify.R;
import com.sv.speakerverify.activities.SettingsActivity;
  ...
  public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    aboutPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
      ...
      public boolean onPreferenceClick(Preference preference) {
        ...
        licensesFragment
            .show(((SettingsActivity) getActivity()).getSupportFragmentManager().beginTransaction(),
                "dialog_licenses");
        return true;
      }
    });
